...
python run_finetune_siamese.py \
    ...
    --output_dir /scratch/mhussein/contrastive-product-matching/reports/contrastive-ft-siamese/dblpscholar-clean-$AUG$BATCH-$PREAUG$LR-$TEMP-frozen-roberta-base/ \

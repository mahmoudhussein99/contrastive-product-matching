...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint /scratch/mhussein/contrastive-product-matching/reports/contrastive/dblpscholar-$PREAUG$BATCH-$LR-$TEMP-roberta-base/pytorch_model.bin \
    --do_train \
    ...
    --output_dir /scratch/mhussein/contrastive-product-matching/reports/contrastive-ft-siamese/dblpscholar-$AUG$BATCH-$PREAUG$LR-$TEMP-unfrozen-roberta-base/ \
